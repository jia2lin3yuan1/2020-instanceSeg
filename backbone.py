...
try:
    ...
    def DCN(*args, **kwdargs):
        raise Exception('DCN could not be imported. If you want to use DVIS models, compile DCN. Check the README for instructions.')
...
class DarkNetBackbone(nn.Module):
    ...
    def __init__(self, layers=[1, 2, 8, 8, 4], block=DarkNetBlock, in_channels=32):
        super().__init__()
...
class VGGBackbone(nn.Module):
    ...
    def __init__(self, cfg, extra_args=[], norm_layers=[], in_channels=3):
        super().__init__()
