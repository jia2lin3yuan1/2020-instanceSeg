...
class Detect(object):
    ...
    def fast_nms(self, boxes, masks, scores, cfg,
                       iou_threshold:float=0.5, top_k:int=200, second_threshold:bool=False):
    ...
    def traditional_nms(self, boxes, masks, scores, cfg,
                              iou_threshold=0.5, conf_thresh=0.05):
        import pyximport
