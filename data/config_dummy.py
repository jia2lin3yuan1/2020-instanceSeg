...
COCO_CLASSES_FG = ('person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
...
dummy_dataset = dummy_dataset_base.copy({
    'name': 'DUMMY',

    'train_images': None,
    'train_info': None,

    'valid_images': '../dataset/Videos/DAVIS-test/JPEGImages/480p/',
    'valid_info': None,
...
base_network_config = setup_network_base_config(dummy_base_config,
                            dummy_dataset,
                            lr_steps=[100000, 200000, 500000, 700000, 750000],
                            max_size=700)

plus_resnet50_config_700 = change_backbone_resnet50_dcn(base_network_config)
plus_resnet50_config_550 = change_config_imgSize(plus_resnet50_config_700, imgSize=550)

plus_resnet101_config_700 = change_backbone_resnet101_dcn(base_network_config)
plus_resnet101_config_550 = change_config_imgSize(plus_resnet101_config_700, imgSize=550)


# ------------Network config for multiple channel output-----------------#

plus_resnet50_config_550_MC = change_instance_output(plus_resnet50_config_550,
                                            mask_out_ch=64, mask_out_level=[0],
                                            classify_en=1, classify_rs_size=7)

plus_resnet101_config_550_MC = change_instance_output(plus_resnet101_config_550,
                                            mask_out_ch=64, mask_out_level=[0],
                                            classify_en=1, classify_rs_size=7)

# Default config
cfg = plus_resnet50_config_700.copy()
